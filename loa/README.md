...
$ CC A1.cpp 每o LOA
Failure to compile with this instruction will result in the assignment receiving 0.
...
terminal_number2. For example, entering 每t 5 8 should mean providing information

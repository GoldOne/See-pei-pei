...
int main()
{
	mol head=NULL;//initialization

	cout<<"==========Welcome to Lonely Molecules C++ version 1.0 !!!=========="<<endl;
	...
	do
	{
		...
		{
			case 'I':
				total+=import(head,record);
				break;
			case 'N':
				if(record>1)
					cout<<"There are "<<record<<" records imported at this time."<<endl;
				else
					cout<<"There is "<<record<<" record imported at this time."<<endl;
